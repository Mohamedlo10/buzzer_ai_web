...
import { adminApi, useAuthStore } from '@xalaat/core';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-surface-2 rounded-xl text-txt-60 hover:text-txt hover:bg-surface-2 transition-colors text-sm cursor-pointer"
          >
            <RefreshCw size={16} />
            Actualiser
          </button>
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-surface-2 rounded-xl text-bad hover:text-bad-h hover:bg-surface-2 transition-colors text-sm cursor-pointer"
            title="Déconnexion"
          >
            <LogOut size={16} />
          </button>
                    ...
                    <div className="w-full h-1.5 bg-bg rounded-full mt-1">
                      <div
                        ...
                        style={{
                          width: `${Math.min(
                            100,
                            (c.questionCount / (topStats.topCategories[0]?.questionCount || 1)) * 100
                          )}%`,
                        }}
                      />
                    </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-txt-40 text-xs">
                      {s.playerCount}/{s.maxPlayers} joueurs • Q{s.currentQuestionIndex}/
                      {s.totalQuestions}
                    </p>
                  </div>
