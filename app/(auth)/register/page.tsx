      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div
            ...
            style={{
              ...
              height: 120,
              borderRadius: 60,
              boxShadow: '0 0 25px 0 rgb(var(--primary-rgb) / 0.4)',
            }}
          >
            {/* Gradient Ring */}
            <div
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, rgb(var(--primary-rgb) / 0.125), rgb(var(--bad-rgb) / 0.125))',
                  }}
                />
                {/* Logo Image */}
                <img
          ...
          >
            ...
            <span className="text-energy text-xs font-semibold ml-1.5 tracking-wide">
              QUIZ BY MOUHADEV
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div className="mb-5">
            ...
            {errors.email && (
              <p className="text-buzz text-sm mt-2 ml-2">{errors.email}</p>
            )}
          </div>
          ...
          <div className="mb-8">
            ...
            {errors.confirmPassword && (
              <p className="text-buzz text-sm mt-2 ml-2">{errors.confirmPassword}</p>
            )}
          </div>
          ...
          >
            <span className="text-accent text-base font-bold mr-1">Se connecter</span>
